...
public class ViewCgroupConfig {
    ...
    public Map<String, Object> viewCgroupConfig(String name, String controllerID, int hierarchy) {
        ...
        try {
            ...
            // 查询控制器状态
//            boolean cpu_stat = selectedCgroup.getIsCpu_controller_status() == 1 ? true : false;
//            boolean cpuset_stat = selectedCgroup.getIsCpuset_controller_status() == 1 ? true : false;
//            boolean memory_stat = selectedCgroup.getIsMemory_controller_status() == 1 ? true : false;
//            boolean io_stat = selectedCgroup.getIsIo_controller_status() == 1 ? true : false;
//            boolean pids_stat = selectedCgroup.getIsPids_controller_status() == 1 ? true : false;

            boolean cpu_stat = true;
            boolean cpuset_stat = true;
            boolean memory_stat = true;
            boolean io_stat = true;
            boolean pids_stat = true;
