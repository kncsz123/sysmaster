...
//     */
    public Map<String, Object> createCgroup(Map<String, Object> requestBody) {
        ...
        try {
            ...
            insertCgroup.setIsCpu_controller_status(byteValue);
            insertCgroup.setIsMemory_controller_status(byteValue);
            insertCgroup.setIsIo_controller_status(byteValue);
            insertCgroup.setIsPids_controller_status(byteValue);
            insertCgroup.setIsCpuset_controller_status(byteValue);
